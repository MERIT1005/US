...
TOKEN = '7559198676:AAGu9hw4m42N0lICQdL11qoE4U_2XhyPPbk'
MONGO_URI = 'mongodb+srv://rishi:ipxkingyt@rishiv.ncljp.mongodb.net/?retryWrites=true&w=majority&appName=rishiv'
FORWARD_CHANNEL_ID = -1002478854289
CHANNEL_ID = -1002478854289
error_channel_id = -1002478854289
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED BUY ACESS:- @Dpmaster28, @Sanjai10_oct_2k03 😍*", parse_mode='Markdown')
...
def send_not_approved_message(chat_id):
    bot.send_message(
        ...
        "🚀 *Ready to supercharge your experience? Take action and get ready for powerful attacks! DM TO BUY : @Dpmaster28, @Sanjai10_oct_2k03 😍*", 
        parse_mode='Markdown'
    )
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*FOR RESSELER SHIP DM :- @Dpmaster28, @Sanjai10_oct_2k03 😍*", parse_mode='Markdown')
...
if __name__ == "__main__":
    ...
    logging.info("SANJU SERVER RUNNING.....")
    while True:
        try:
